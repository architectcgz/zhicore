...
class CommentControllerTest extends ControllerTestSupport {
    ...
    void shouldReturnParamErrorWhenCursorIsInvalid() throws Exception {
        ...
        doThrow(new BusinessException(ResultCode.PARAM_ERROR, "无效的分页游标"))
                .when(commentService).getTopLevelCommentsByCursor(1001L, "bad-cursor", 20, com.zhicore.comment.application.dto.CommentSortType.TIME);

        mockMvc.perform(org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get("/api/v1/comments/post/{postId}/cursor", 1001L)
    ...
    void shouldRejectInvalidPageSize() throws Exception {
        CommentController controller = new CommentController(commentService);
        var method = CommentController.class.getMethod(
    ...
    void shouldReturnParamErrorWhenTraditionalPaginationWindowExceeded() throws Exception {
        ...
        doThrow(new BusinessException(
                ...
                .when(commentService).getTopLevelCommentsByPage(1001L, 50, 100, CommentSortType.TIME);
