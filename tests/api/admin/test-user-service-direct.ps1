# Direct Test for User Service (Bypass Gateway)
# Test disable/enable user by calling user service directly
...
Write-Host "Direct User Service Test (Bypass Gateway)" -ForegroundColor Cyan
...
# === Test: Disable User (Direct Call) ===
Write-Host ""
Write-Host "=== Test: Disable User (Direct Call) ===" -ForegroundColor Magenta
Write-Host ""

Write-Host "[TEST-01] Testing disable user (direct)..." -ForegroundColor Yellow
...
Write-Host "  Response Body: $($Result.Body | ConvertTo-Json -Depth 5)" -ForegroundColor Gray
...
# === Test: Enable User (Direct Call) ===
Write-Host ""
Write-Host "=== Test: Enable User (Direct Call) ===" -ForegroundColor Magenta
Write-Host ""

Write-Host "[TEST-02] Testing enable user (direct)..." -ForegroundColor Yellow
