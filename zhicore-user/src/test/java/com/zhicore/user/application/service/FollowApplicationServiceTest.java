...
class FollowApplicationServiceTest {
    ...
    @Mock
    private UserEventPort eventPublisher;
    ...
    void setUp() {
        ...
        followApplicationService = new FollowApplicationService(
                userRepository,
    ...
    void followShouldUseLockManagerAndUnlock() {
        ...
        followApplicationService.follow(followerId, followingId);
    ...
    void followShouldFailWhenLockNotAcquired() {
        ...
        assertThrows(BusinessException.class, () -> followApplicationService.follow(followerId, followingId));
