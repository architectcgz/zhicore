...
@DisplayName("CheckInApplicationService 测试")
class CheckInApplicationServiceTest {
    ...
    void getMonthlyBitmap_shouldDelegateToStore() {
        ...
        long bitmap = checkInApplicationService.getMonthlyCheckInBitmap(1001L, yearMonth);
    ...
    void checkIn_shouldRejectWhenBitmapAlreadyMarked() {
        ...
        BusinessException exception = assertThrows(BusinessException.class,
                () -> checkInApplicationService.checkIn(1001L));
    ...
    void checkIn_shouldMarkBitmapViaStore() {
        ...
        CheckInVO result = checkInApplicationService.checkIn(1001L);
