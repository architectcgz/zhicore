...
public class UserSentinelConfig {
    ...
    private static final String CONFIG_PREFIX = "user.sentinel";
    ...
    public void onEnvironmentChange(EnvironmentChangeEvent event) {
        ...
        log.info("检测到用户服务 Sentinel 配置变更，重新加载热点读接口规则: {}", event.getKeys());
        initFlowRules();
    }

    @EventListener(RefreshScopeRefreshedEvent.class)
    public void onRefreshScopeRefreshed() {
        log.info("检测到用户服务 RefreshScope 刷新事件，重新加载热点读接口 Sentinel 规则");
        initFlowRules();
    }
