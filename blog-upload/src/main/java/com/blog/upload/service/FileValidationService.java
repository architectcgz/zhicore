...
public interface FileValidationService {
     ...
     * 
     * @param file 文件对象
     * @throws com.blog.upload.exception.FileValidationException 如果验证失败
     */
     ...
     * @throws com.blog.upload.exception.FileSizeExceededException 如果文件过大
     */
     ...
     * @throws com.blog.upload.exception.InvalidFileTypeException 如果类型不允许
     */
