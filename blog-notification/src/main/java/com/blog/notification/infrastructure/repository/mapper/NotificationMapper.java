package com.blog.notification.infrastructure.repository.mapper;

import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.blog.notification.application.dto.AggregatedNotificationDTO;
import com.blog.notification.infrastructure.repository.po.NotificationPO;
...
public interface NotificationMapper extends BaseMapper<NotificationPO> {
    ...
    @Select("""
        ...
        """)
    @Results({
        @Result(property = "actorIds", column = "actorIds", typeHandler = com.blog.notification.infrastructure.repository.typehandler.StringArrayTypeHandler.class)
    })
