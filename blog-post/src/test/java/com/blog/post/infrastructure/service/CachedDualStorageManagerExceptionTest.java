...
class CachedDualStorageManagerExceptionTest {
    ...
    private DualStorageManager.PostDetail createTestPostDetail() {
        com.blog.post.domain.model.Post post = com.blog.post.domain.model.Post.reconstitute(
            TEST_POST_ID,
            1L,  // ownerId
            "Test Post",
            null,  // excerpt
            null,  // coverImage
            com.blog.post.domain.model.PostStatus.PUBLISHED,
            null,  // topicId
            ...
            false,  // isArchived
            com.blog.post.domain.model.PostStats.empty()
        );
