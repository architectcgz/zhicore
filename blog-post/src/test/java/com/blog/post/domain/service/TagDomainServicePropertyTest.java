...
class TagDomainServicePropertyTest {
    ...
    void findOrCreateIsIdempotent(
        ...
        try {
            ...
            // 创建一个 Tag 实例用于模拟返回
            Long tagId = 12345L;
            com.blog.post.domain.model.Tag mockTag = com.blog.post.domain.model.Tag.create(tagId, tagName.trim(), slug);
            ...
            Mockito.when(mockRepository.save(Mockito.any(com.blog.post.domain.model.Tag.class)))
                .thenReturn(mockTag);
            
            // When: 对同一个 Tag 名称多次调用 findOrCreate()
            com.blog.post.domain.model.Tag tag1 = service.findOrCreate(tagName);
            com.blog.post.domain.model.Tag tag2 = service.findOrCreate(tagName);
            com.blog.post.domain.model.Tag tag3 = service.findOrCreate(tagName);
            ...
            Mockito.verify(mockRepository, Mockito.times(1))
                .save(Mockito.any(com.blog.post.domain.model.Tag.class));
    ...
    void findOrCreateIsIdempotentAcrossCaseAndSpaceVariations(
        ...
        try {
            ...
            // 创建一个 Tag 实例用于模拟返回
            Long tagId = 67890L;
            com.blog.post.domain.model.Tag mockTag = com.blog.post.domain.model.Tag.create(tagId, baseTagName.trim(), slug);
            ...
            com.blog.post.domain.model.Tag tag1 = service.findOrCreate(baseTagName);
            com.blog.post.domain.model.Tag tag2 = service.findOrCreate(lowercase);
            com.blog.post.domain.model.Tag tag3 = service.findOrCreate(uppercase);
            com.blog.post.domain.model.Tag tag4 = service.findOrCreate(withSpaces);
            com.blog.post.domain.model.Tag tag5 = service.findOrCreate(mixedCase);
    ...
    void findOrCreateHandlesConcurrentCreation(
        ...
        try {
            ...
            com.blog.post.domain.model.Tag result = service.findOrCreate(tagName);
