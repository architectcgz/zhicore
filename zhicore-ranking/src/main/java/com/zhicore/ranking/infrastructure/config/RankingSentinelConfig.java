...
public class RankingSentinelConfig {
    ...
    private static final String CONFIG_PREFIX = "ranking.sentinel";
    ...
    public void onEnvironmentChange(EnvironmentChangeEvent event) {
        ...
        log.info("检测到排行榜 Sentinel 配置变更，重新加载限流规则: {}", event.getKeys());
        initFlowRules();
    }

    @EventListener(RefreshScopeRefreshedEvent.class)
    public void onRefreshScopeRefreshed() {
        log.info("检测到排行榜 RefreshScope 刷新事件，重新加载 Sentinel 限流规则");
        initFlowRules();
    }
