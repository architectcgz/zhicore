...
public class PostRankingQueryService {
    ...
    public List<String> getWeeklyHotPosts(int weekBasedYear, int weekNumber, int limit) {
        return postRankingStore.getWeeklyHotPosts(weekBasedYear, weekNumber, limit);
    }
    ...
    public List<HotScore> getWeeklyHotPostsWithScore(int weekBasedYear, int weekNumber, int limit) {
        return postRankingStore.getWeeklyHotPostsWithScore(weekBasedYear, weekNumber, limit);
    }
