...
import com.blog.comment.infrastructure.feign.BlogUploadClient;
...
public class CommentMediaController {
    ...
    public ApiResponse<String> uploadImage(
        ...
        // 调用 blog-upload 服务上传图片
        ApiResponse<BlogUploadClient.FileUploadResponse> response = blogUploadClient.uploadImage(file);
    ...
    public ApiResponse<String> uploadVoice(
        ...
        // 调用 blog-upload 服务上传音频
        ApiResponse<BlogUploadClient.FileUploadResponse> response = blogUploadClient.uploadAudio(file);
