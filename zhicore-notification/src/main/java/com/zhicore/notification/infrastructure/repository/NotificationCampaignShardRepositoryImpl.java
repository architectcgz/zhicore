...
public class NotificationCampaignShardRepositoryImpl implements NotificationCampaignShardRepository {
    ...
    @Override
    public Optional<NotificationCampaignShard> claimNextPending(Long campaignId) {
        return Optional.ofNullable(mapper.claimNextPending(campaignId)).map(this::toDomain);
    }
