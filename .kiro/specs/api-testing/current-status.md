...
| 服务 | 测试用例 | 状态 | 通过率 | 完成日期 |
|------|---------|------|--------|---------|
| 用户服务 (ZhiCore-user) | 35 | ✅ 完成 | 100% | 2026-01-14 |
| 文章服务 (ZhiCore-post) | 41 | ✅ 完成 | 100% | 2026-01-15 |
| 评论服务 (ZhiCore-comment) | 36 | ✅ 完成 | 100% | 2026-01-16 |
| 消息服务 (ZhiCore-message) | 20 | ✅ 完成 | 100% | 2026-01-16 |
| 通知服务 (ZhiCore-notification) | 27 | ✅ 完成 | 100% | 2026-01-16 |
| 搜索服务 (ZhiCore-search) | 12 | ✅ 完成 | 100% | 2026-01-16 |
| 排行榜服务 (ZhiCore-ranking) | 12 | ✅ 完成 | 100% | 2026-01-16 |
| 上传服务 (ZhiCore-upload) | 15 | ✅ 完成 | 100% | 2026-01-16 |
...
**前置条件**:
- ZhiCore-gateway 服务运行 (8000)
- 至少一个后端服务运行 (如 ZhiCore-post)
- Redis 运行 (用于限流)
...
**应用服务**:
- ✅ ZhiCore-leaf (8010) - ID生成服务
- ✅ ZhiCore-user (8081) - 用户服务
- ✅ ZhiCore-post (8082) - 文章服务
- ✅ ZhiCore-comment (8083) - 评论服务
- ✅ ZhiCore-message (8086) - 消息服务
- ✅ ZhiCore-notification (8086) - 通知服务
- ✅ ZhiCore-search (8086) - 搜索服务
- ✅ ZhiCore-ranking (8088) - 排行榜服务
- ✅ ZhiCore-upload (8089) - 上传服务
- ✅ ZhiCore-admin (8090) - 管理后台服务
- ⏳ ZhiCore-gateway (8000) - 网关服务 (待测试)
