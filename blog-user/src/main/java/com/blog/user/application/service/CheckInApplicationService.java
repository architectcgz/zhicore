...
import com.blog.user.domain.model.UserCheckIn;
import com.blog.user.domain.model.UserCheckInStats;
import com.blog.user.domain.repository.UserCheckInRepository;
...
public class CheckInApplicationService {
    ...
    private final com.blog.user.domain.repository.UserRepository userRepository;
