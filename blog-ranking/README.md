...
spring:
  ...
  data:
    ...
    # MongoDB 配置
    mongodb:
      uri: mongodb://admin:mongo123456@localhost:27017/blog?authSource=admin
      database: blog
...
2. **启动 MongoDB**：
   ```bash
   docker run -d --name blog-mongodb \
     -p 27017:27017 \
...
```bash
# 查看归档日志
grep "归档" logs/blog-ranking.log

# 查看错误日志
grep "ERROR" logs/blog-ranking.log

# 查看本地聚合日志
grep "ScoreBufferService" logs/blog-ranking.log
```
...
- [设计文档](.kiro/specs/blog-ranking-time-based-endpoints/design.md)
- [需求文档](.kiro/specs/blog-ranking-time-based-endpoints/requirements.md)
- [任务列表](.kiro/specs/blog-ranking-time-based-endpoints/tasks.md)
...
Copyright © 2024 Blog Team. All rights reserved.
